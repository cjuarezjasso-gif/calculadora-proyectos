...
$id_usuario = $_SESSION['id_usuario']; // Guardamos quién eres
...
$campos = [
    ...
    'saldo_inicial', 'pct_cobro_efectivo', 'inv_inicial_pt_val',
...
if (empty($id_proyecto)) {
    ...
    $sql = "INSERT INTO proyectos ($columnas_sql, fk_id_usuario) VALUES ($placeholders_sql, :fk_id_usuario) RETURNING id_proyecto INTO :id_generado";
    $stmt = oci_parse($conexion, $sql);
    oci_bind_by_name($stmt, ':fk_id_usuario', $id_usuario);
